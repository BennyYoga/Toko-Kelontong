                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-style-1">
                                ...
                                <input type="text" placeholder="Nama Customer" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-style-1">
                                ...
                                <input type="text" placeholder="Kode Customer" class="form-control @error('kode') is-invalid @enderror" name="kode" value="{{ old('kode') }}">
                        ...
                        <div class="col-sm-6">
                            <div class="input-style-1">
                                ...
                                <input type="text" placeholder="No Telepon" class="form-control @error('telp') is-invalid @enderror" name="telp" value="{{ old('telp') }}">
